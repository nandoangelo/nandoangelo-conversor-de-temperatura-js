...
function converteTemperatura() {
  ...
  // Forçando a conversão do valor do campo em número
  ...
  if (simbolo[0].selected) {
    ...
    // Então converte graus celsius em... 
    var fahrenheit = (temperatura * 9/5) + 32;
    var kelvin = temperatura + 273.15;

    // ... escreve a resposta no espaço reservado
    ...
    // Então converte graus fahrenheit em...
